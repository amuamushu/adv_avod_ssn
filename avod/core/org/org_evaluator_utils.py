...
def copy_kitti_native_code(checkpoint_name,output_dir=None):
    ...
    kitti_native_code_copy = os.path.join(output_dir,checkpoint_name) + \
...
def run_kitti_native_script_with_05_iou(checkpoint_name, score_threshold,
    ...
    if output_dir is None:
        ...
        results_dir = os.path.join(output_dir,checkpoint_name) + '/offline_eval/results_05_iou/'

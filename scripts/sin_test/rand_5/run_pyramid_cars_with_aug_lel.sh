...
CONFIG_EVALSIN=avod/configs/lel/rand_5/pyramid_cars_with_aug_lel_evalsin_rand_5.config
CONFIG_EVALAIN=avod/configs/lel/rand_5/pyramid_cars_with_aug_lel_evalain_rand_5.config
